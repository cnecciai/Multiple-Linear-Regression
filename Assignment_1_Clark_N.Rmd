...
|       With our goals centered on finding the most significant predictors with respect to determining the total number of hour-by-hour rentals, we decided to partition our data 80% towards training the model and 20% for testing model performance. Allowing a significant majority of our overall dataset to go towards the model fitting process enables us to get better coefficient estimates as long as we have clean, non-noisy data.
...
plot(OLSregbacksum$bic, xlab = "Number of Variables", ylab = "BIC",
    ...
    panel.first = grid(nx = NULL, ny = NULL, col = "gray", lty = 2))
points(36, OLSregbacksum$bic[36], col = "darkred", cex = 1, pch = 20)
