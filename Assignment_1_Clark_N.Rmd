...
CBS <- dummy_cols(CBS, select_columns = 
                    c("season", "year", "month", "hour", "day", "weather"),
                  remove_first_dummy = T) %>%
  dplyr::select(-c(season, year, month, hour, day, weather))
...
OLS.regback <- leaps::regsubsets(cube_root_total ~ . - count_rentals - temp - workingday , train, method = "seqrep", nvmax = 70)
...
plot(OLSregbacksum$adjr2, xlab = "Number of Variables",
    ...
    font.lab = 2, panel.first = grid(nx = NULL, ny = NULL, col = "gray",
        lty = 2))
points(41, OLSregbacksum$adjr2[41], col = "#336699", cex = 2, pch = 20)
...
points(41, OLSregbacksum$bic[41], col = "#336699", cex = 2, pch = 20)
```
